...
export default function Register() {
    ...
    return (
        ...
        <input type="password" name="confirmPassword" value={values.confirmPassword} onChange={onChange} placeholder="Password"></input>

        <button type="submit" className="btn btn-primary btn-secondary py-2 px-4 margin authButtons">Register</button>
      </form>
    )
}